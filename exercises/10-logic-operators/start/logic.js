...
users.forEach( function(user) {
  if( user.age >= 100 __ user.isLoggedIn == true ){
    console.log( user.displayName + ' is logged in and is old, time to increase the font size.' );
  }
});

if ( bankAccount.isLoggedIn == true __ bankAccount.totalAmount < 500 ) {
  console.log( 'Welcome back! Looks like you are below you preset low balance' );
}

if ( physicalObject.length > 20 __ physicalObject.weight > 200 ) {
